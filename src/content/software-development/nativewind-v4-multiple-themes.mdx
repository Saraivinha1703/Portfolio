---
title: Multiple Themes with Expo and Nativewind v4
description: Making multiple themes with nativewind v4 and Expo is very simple! Nativewind v4 is not released yet, so it may cause some warning and unexpected behaviors, but overall it is very powerful and useful! Check out in this article how to configure a multiple theme provider with nativewind v4 and how easy it is to use it and add new themes.
date: 2024-06-17
tags:
    - Nativewind v4
    - Expo
...
<div className="flex-1">
  <img src="/images/content/nativewind-v4-multiple-themes/system-theme.png" className="rounded-lg" width={200} height={600} />
</div>
<div className="flex-1">
  <img src="/images/content/nativewind-v4-multiple-themes/light-theme.png" className="rounded-lg" width={200} height={600} />
</div>

<div className="flex-1">
  <img src="/images/content/nativewind-v4-multiple-themes/dark-theme.png" className="rounded-lg" width={200} height={600} />
</div>

<div className="flex-1">
  <img src="/images/content/nativewind-v4-multiple-themes/deep-ocean-theme.png" className="rounded-lg" width={200} height={600} />
</div>
</div>
...
![](/images/content/nativewind-v4-multiple-themes/install-typescript.png)
